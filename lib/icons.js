...
const ICONS = {
  ...
  'shopping-bag': '<path d="M6 9V7a6 6 0 0 1 12 0v2"/><path d="M4.5 9h15l-1.1 10.2a2 2 0 0 1-2 1.8H7.6a2 2 0 0 1-2-1.8L4.5 9z"/>',
  sparkles: '<path d="M12 3l1.7 4.6L18 9.3l-4.3 1.7L12 15.6l-1.7-4.6L6 9.3l4.3-1.7L12 3z"/><path d="M19 14.5l.9 2.3 2.3.9-2.3.9-.9 2.3-.9-2.3-2.3-.9 2.3-.9z"/>',
